...
{ 
    ...
    private void FillDropDownList()
    {
        ...
        ddlIsDefault.Items.Insert(0, new ListItem("Select IsDefault", "-99"));
        ddlIsDefault.Items.Insert(1, new ListItem("Yes", "true"));
        ddlIsDefault.Items.Insert(2, new ListItem("No", "false"));
        ddlIsDefault.SelectedValue = "true";
    ...
    private void Search(int PageNo)
    {
        ...
        if (ddlIsDefault.SelectedIndex > 0)
            IsDefault = Convert.ToBoolean(ddlIsDefault.SelectedValue);
    ...
    protected void lbtnExport_Click(object sender, EventArgs e)
    {
        ...
        if (ddlIsDefault.SelectedIndex > 0)
            IsDefault = Convert.ToBoolean(ddlHospitalID.SelectedValue);
