...
public partial class AdminPanel_MST_ExpenseType_MST_ExpenseTypeList : System.Web.UI.Page
{
    #region 11.0 Variables

    String FormName = "MST_ExpenseTypeList";
    ...
    private void Search(int PageNo)
    {
        ...
        DataTable dt = balMST_ExpenseType.SelectPage(Offset, PageRecordSize, out TotalRecords, ExpenseType, HospitalID);
    ...
    protected void lbtnExport_Click(object sender, EventArgs e)
    {
        ...
        MST_ExpenseTypeBAL balMST_ExpenseType = new MST_ExpenseTypeBAL();
        DataTable dtMST_ExpenseType = balMST_ExpenseType.SelectPage(Offset, PageRecordSize, out TotalReceivedRecord, ExpenseType, HospitalID);
