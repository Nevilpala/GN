                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td class="text-nowrap text-center">
                                                                <asp:HyperLink CssClass="modalButton"  ID="hlPopup" SkinID="EditPopup" NavigateUrl='<%# "~/AdminPanel/Master/MST_FinYear/MST_FinYearAddEditPopup.aspx?FinYearID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("FinYearID").ToString()) %>'  data-target="#viewiFrameReg" data-toggle="modal" runat="server"></asp:HyperLink>
