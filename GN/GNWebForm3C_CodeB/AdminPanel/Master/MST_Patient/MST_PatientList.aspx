<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="MST_PatientList.aspx.cs" Inherits="AdminPanel_Master_MST_Patient_MST_PatientList" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <div>
                                    <asp:HyperLink SkinID="hlAddNew" ID="hlAddNew" NavigateUrl="~/AdminPanel/Master/MST_Patient/MST_PatientAddEdit.aspx" runat="server"></asp:HyperLink>
                                        ...
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    ...
                                                    <th>
                                                        <asp:Label ID="lbhPatientName" runat="server" Text="Patient Name"></asp:Label>
                                                    </th>

                                                    <th class="text-center">
                                                        <asp:Label ID="lbhAge" runat="server" Text="Age"></asp:Label>
                                                    </th>
                                                    <th>
                                                        <asp:Label ID="lbhMobileNo" runat="server" Text="Mobile No"></asp:Label>
                                                    </th>
                                                    <th>
                                                        <asp:Label ID="lbhPrimaryDesc" runat="server" Text="PrimaryDesc"></asp:Label>
                                                    </th>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <td>
                                                                <asp:HyperLink ID="HyperLink1" NavigateUrl='<%# "~/AdminPanel/Master/MST_Patient/MST_PatientView.aspx?PatientID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("PatientID").ToString()) %>' data-target="#viewiFrameSM" CssClass="modalButton" data-toggle="modal" runat="server">
                                                                    <asp:Image
                                                                        ID="imgPhotoPath"
                                                                        CssClass="img-circle"
                                                                        runat="server"
                                                                        ImageUrl='<%# Eval("PatientPhotoPath").ToString().Trim() == String.Empty? GNForm3C.CV.DefaultNoImagePath.ToString() : Eval("PatientPhotoPath").ToString()%>'
                                                                        Width="50px"
                                                                        Height="50px" />
                                                                </asp:HyperLink>
                                                            </td>
                                                            <td>
                                                                <asp:HyperLink ID="hlViewPatientID" NavigateUrl='<%# "~/AdminPanel/Master/MST_Patient/MST_PatientView.aspx?PatientID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("PatientID").ToString()) %>' data-target="#viewiFrameSM" CssClass="modalButton" data-toggle="modal" runat="server"><%#Eval("PatientName") %></asp:HyperLink>
                                                            </td>
                                                            ...
                                                            <td class="text-nowrap text-center">
                                                                <asp:HyperLink ID="hlView" SkinID="View" NavigateUrl='<%# "~/AdminPanel/Master/MST_Patient/MST_PatientView.aspx?PatientID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("PatientID").ToString()) %>' data-target="#viewiFrameReg" data-toggle="modal" runat="server"></asp:HyperLink>
                                                                <asp:HyperLink ID="hlEdit" SkinID="Edit" NavigateUrl='<%# "~/AdminPanel/Master/MST_Patient/MST_PatientAddEdit.aspx?PatientID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("PatientID").ToString()) %>' runat="server"></asp:HyperLink>
                                                                <asp:HyperLink ID="hlPrint" SkinID="hlPrint"  ToolTip="Print ID Card"  NavigateUrl='<%# "~/AdminPanel/Reports/RPT_MST_Patient/RPT_PatientIDCard.aspx?PatientID="+ GNForm3C.CommonFunctions.EncryptBase64(Eval("PatientID").ToString()) + "&ReportType=" +GNForm3C.CommonFunctions.EncryptBase64("PDF") %>' runat="server"></asp:HyperLink>
