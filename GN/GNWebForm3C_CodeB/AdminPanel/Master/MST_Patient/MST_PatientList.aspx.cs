...
public partial class AdminPanel_Master_MST_Patient_MST_PatientList : System.Web.UI.Page
{
    ...
    String FormName = "MST_PatientList";
    static Int32 PageRecordSize = CV.PageRecordSize;//Size of record per page
    
    static String NoImage = CV.DefaultNoImagePath;
    ...
    private void Search(int PageNo)
    {
        ...
        SqlString PatientName = SqlString.Null;
        SqlInt32 Age = SqlInt32.Null;
        SqlString MobileNo = SqlString.Null;  
        SqlDateTime DOB = SqlDateTime.Null;
        ...
        DataTable dt = balMST_Patient.SelectPage(Offset, PageRecordSize, out TotalRecords, PatientName, Age,MobileNo,DOB);
    ...
    protected void rpData_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "DeleteRecord")
        {
            try
            {
                ...
                {
                    if (balMST_Patient.Delete(Convert.ToInt32(e.CommandArgument)))
                    {
    ...
    protected void lbtnExport_Click(object sender, EventArgs e)
    {
        ...
        MST_PatientBAL balMST_Patient = new MST_PatientBAL();
        DataTable dtMST_Patient =  balMST_Patient.SelectPage(Offset, PageRecordSize, out TotalReceivedRecord, PatientName, Age, MobileNo, DOB);
        if (dtMST_Patient != null && dtMST_Patient.Rows.Count > 0)
        {
            Session["ExportTable"] = dtMST_Patient;
