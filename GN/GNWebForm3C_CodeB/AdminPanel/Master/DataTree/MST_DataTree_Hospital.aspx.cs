...
public partial class AdminPanel_Master_DataTree_MST_DataTree_Hospital : System.Web.UI.Page
{
    ...
    protected void rptHospitals_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "LoadFinYear")
        {
            try
            {
                ...
                HiddenField hfHospitalID = (HiddenField)e.Item.FindControl("hfhospitalID");
                Repeater rptFinYears = (Repeater)e.Item.FindControl("rptFinYears");

                if (hfHospitalID.Value != string.Empty)
                    HospitalID = Convert.ToInt32(hfHospitalID.Value);

                MST_Hospital_DataTreeBAL balMST_Hospital_DataTree = new MST_Hospital_DataTreeBAL();
                DataTable dt = balMST_Hospital_DataTree.SelectPage(HospitalID, FinYearID, OneDateOfMonth);

                rptFinYears.DataSource = dt;
                ...
                //        {
                //            int Count = rptHospitals.Items.Count;
    ...
    protected void rptFinYears_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
    ...
    protected void rptHospitals_OnItemDataBound(object sender, RepeaterItemEventArgs e)
    {
    ...
    protected void rptFinYears_OnItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        //SqlInt32 HospitalID = SqlInt32.Null;
        //SqlInt32 FinYearID = SqlInt32.Null;
        //SqlDateTime OneDateOfMonth = SqlDateTime.Null;
        ...
        //HiddenField hfParentHospitalID = (HiddenField)parentItem.FindControl("hfHospitalID");

        //HiddenField hfFinYearID = (HiddenField)e.Item.FindControl("hfFinYearID");
        //HiddenField hfHospitalID = (HiddenField)e.Item.FindControl("hfHospitalID");

        //Repeater rptMonth = (Repeater)e.Item.FindControl("rptMonth");

        //if (hfParentHospitalID.Value != string.Empty)
        //{
        //    HospitalID = Convert.ToInt32(hfParentHospitalID.Value);
        //    hfHospitalID.Value = hfParentHospitalID.Value;  
        //}
        //if (hfFinYearID.Value != string.Empty)
    ...
    protected void rptMonth_OnItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        //SqlInt32 HospitalID = SqlInt32.Null;
        //SqlInt32 FinYearID = SqlInt32.Null;
        //SqlDateTime OneDateOfMonth = SqlDateTime.Null;
        ...
        //HiddenField hfHospitalID = (HiddenField)e.Item.FindControl("hfhospitalID");
        //HiddenField hfFinYearID = (HiddenField)e.Item.FindControl("hfFinYearID");
        //HiddenField hfOneDateOfMonth = (HiddenField)e.Item.FindControl("hfOneDateOfMonth");
        //Repeater rptMonth = (Repeater)e.Item.FindControl("rptIncome");

        //if (hfHospitalID.Value != string.Empty)
        //    HospitalID = Convert.ToInt32(hfHospitalID.Value);
        //if (hfFinYearID.Value != string.Empty)
        //    FinYearID = Convert.ToInt32(hfHospitalID.Value);

        //if (hfOneDateOfMonth.Value != string.Empty)
        //    OneDateOfMonth = Convert.ToDateTime(hfOneDateOfMonth.Value.ToString());
