...
public partial class AdminPanel_Master_DataTree_MST_Hospital_DataTree : System.Web.UI.Page
{
        ...
        if (e.CommandName == "LoadFinYears")
        {
            ...
            if (panelFinYears != null)
            {
                ...
                else
                {
                    ...
                    DataTable dtFinYears = balMST_Hospital_DataTree.SelectPage(HospitalID, FinYearID, OneDateOfMonth);
        ...
        if (e.CommandName == "LoadMonths")
        {
            ...
            if (panelMonths != null)
            {
                ...
                else
                {
                    ...
                    MST_Hospital_DataTreeBAL balMST_Hospital_DataTree = new MST_Hospital_DataTreeBAL();
                    DataTable dtMonths = balMST_Hospital_DataTree.SelectPage(HospitalID, FinYearID, OneDateOfMonth);
        ...
        if (e.CommandName == "LoadIncomes")
        {
            ...
            if (panelIncomes != null)
            {
                ...
                else
                {
                    ...
                    MST_Hospital_DataTreeBAL aCC_IncomeListBAL = new MST_Hospital_DataTreeBAL();
                    DataTable dtIncomes = aCC_IncomeListBAL.SelectPage(HospitalID, FinYearID, OneDateOfMonth);
