<%@ Page Title="" Language="C#" MasterPageFile="~/Default/MasterPage.master" AutoEventWireup="true" CodeFile="DemoList.aspx.cs" Inherits="AdminPanel_Demo_Demo_DemoList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphPageHeader" runat="Server">
    ...
    <small>
        <asp:Label ID="lblPageHeaderInfo_XXXXX" runat="server" Text="Demo"></asp:Label></small>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtDemoName" CssClass="First form-control" runat="server" PlaceHolder="Enter Demo Name"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <div>
                                    <asp:HyperLink SkinID="hlAddNew" ID="hlAddNew" NavigateUrl="~/AdminPanel/Demo/Demo/DemoAddEdit.aspx" runat="server"></asp:HyperLink>
                                    ...
                                    <div id="TableContent">
                                        <table class="table table-bordered table-advanced table-striped table-hover" id="sample_1">
                                            ...
                                            <thead>
                                                <tr class="TRDark">
                                                    <th>
                                                        <asp:Label ID="lbhDemoName" runat="server" Text="Demo Name"></asp:Label>
                                                    </th>
                                                    <th>
                                                        <asp:Label ID="lbhDemoType" runat="server" Text="Demo Type"></asp:Label>
                                                    </th>
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpData" runat="server" OnItemCommand="rpData_ItemCommand">
                                                    <ItemTemplate>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <td>
                                                                <asp:HyperLink ID="hlViewDemoID" NavigateUrl='<%# "~/AdminPanel/Demo/Demo/DemoView.aspx?DemoID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("DemoID").ToString()) %>' data-target="#viewiFrameReg" CssClass="modalButton" data-toggle="modal" runat="server"><%#Eval("DemoName") %></asp:HyperLink>
                                                            </td>
                                                            ...
                                                            <td class="text-nowrap text-center">
                                                                <asp:HyperLink ID="hlView" SkinID="View" NavigateUrl='<%# "~/AdminPanel/Demo/Demo/DemoView.aspx?DemoID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("DemoID").ToString()) %>' data-target="#viewiFrameReg" data-toggle="modal" runat="server"></asp:HyperLink>
                                                                <asp:HyperLink ID="hlEdit" SkinID="Edit" NavigateUrl='<%# "~/AdminPanel/Demo/Demo/DemoAddEdit.aspx?DemoID=" + GNForm3C.CommonFunctions.EncryptBase64(Eval("DemoID").ToString()) %>' runat="server"></asp:HyperLink>
