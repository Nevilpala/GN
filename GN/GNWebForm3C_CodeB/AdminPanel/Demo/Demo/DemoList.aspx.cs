...
public partial class AdminPanel_Demo_Demo_DemoList : System.Web.UI.Page
{
    ...
    private void Search(int PageNo)
    {
        ...
        SqlString DemoType = SqlString.Null;
        ...
        if (txtDemoType.Text.Trim() != String.Empty)
            DemoType = txtDemoType.Text.Trim();
        ...
        DataTable dt = balDemo.SelectPage(Offset, PageRecordSize, out TotalRecords, DemoName, DemoType);
    ...
    protected void lbtnExport_Click(object sender, EventArgs e)
    {
        ...
        DemoBAL balDemo = new DemoBAL();
        DataTable dtDemo = balDemo.SelectPage(Offset, PageRecordSize, out TotalReceivedRecord, DemoName, DemoType);
