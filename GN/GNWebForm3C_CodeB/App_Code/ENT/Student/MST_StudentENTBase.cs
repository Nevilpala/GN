    ...
    public abstract class MST_StudentENTBase
    {
        ...
        public override String ToString()
        {
            ...
            if (!StudentName.IsNull)
                MST_StudentENT_String += "| Student = " + StudentName.Value;
            ...
            if (!EmailInstitute.IsNull)
                MST_StudentENT_String += "| EmailIntitute = " + EmailInstitute.Value;

            if (!EmailPersonal.IsNull)
                MST_StudentENT_String += "| EmailPersonal = " + EmailPersonal.Value;

            if (!BirthDate.IsNull)
                MST_StudentENT_String += "| BirthDate = " + BirthDate.Value.ToString();
