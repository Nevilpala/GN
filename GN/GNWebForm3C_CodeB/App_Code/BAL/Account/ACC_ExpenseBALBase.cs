...
namespace GNForm3C.BAL
{
	public abstract class ACC_ExpenseBALBase
	{
        ...
        #region Ledger
        public DataTable LeadgerSelectPage(SqlInt32 PageOffset, SqlInt32 PageSize, out Int32 TotalRecords, SqlInt32 ExpenseTypeID, SqlDecimal Amount, SqlDateTime ExpenseDate, SqlInt32 HospitalID, SqlInt32 FinYearID)
		{
			ACC_ExpenseDAL dalACC_Expense = new ACC_ExpenseDAL();
			return dalACC_Expense.SelectPage(PageOffset, PageSize, out TotalRecords, ExpenseTypeID, Amount, ExpenseDate, HospitalID, FinYearID);
		}
        ...
        #region Report 
        public DataTable PP_HospitalWiseExpenseList(SqlDateTime FromDate, SqlDateTime ToDate,SqlInt32 HospitalID)
        {
            ACC_ExpenseDAL dalACC_Expense = new ACC_ExpenseDAL();
            return dalACC_Expense.PP_HospitalWiseExpenseList(FromDate,ToDate, HospitalID);
        }
        #endregion
