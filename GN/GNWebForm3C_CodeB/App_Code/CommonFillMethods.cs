...
namespace GNForm3C
{
    public class CommonFillMethods
    {
        ...
        public static void FillDropDownListExpenseTypeIDWithHospitalName(DropDownList ddl)
        {
            MST_ExpenseTypeBAL balMST_ExpenseType = new MST_ExpenseTypeBAL();
            ddl.DataSource = balMST_ExpenseType.SelectComboBoxWithHospitalName();
            ddl.DataValueField = "ExpenseTypeID";
            ddl.DataTextField = "ExpenseType";
            ddl.DataBind();
            ddl.Items.Insert(0, new ListItem("Select Expense Type", "-99"));
        ...
        public static void FillDropDownListPatient(DropDownList ddl)
        {
