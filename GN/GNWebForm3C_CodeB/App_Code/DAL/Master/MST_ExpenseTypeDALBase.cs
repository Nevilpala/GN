...
namespace GNForm3C.DAL
{
	public abstract class MST_ExpenseTypeDALBase : DataBaseConfig
	{
        ...
        public DataTable SelectComboBoxWithHospitalName()
        {
            try
            {
                SqlDatabase sqlDB = new SqlDatabase(myConnectionString);
                DbCommand dbCMD = sqlDB.GetStoredProcCommand("PR_MST_ExpenseType_SelectComboBoxWithHospitalName");

                DataTable dtMST_ExpenseType = new DataTable("PR_MST_ExpenseType_SelectComboBoxWithHospitalName");
